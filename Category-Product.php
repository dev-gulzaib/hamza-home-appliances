...
$sql12="SELECT * FROM categories WHERE id='$get_scat_id' ORDER BY id DESC";
				...
				<div class="content-area shop-grid-content full-width col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="site-main">
						...
						<ul class="row list-products auto-clear equal-container product-grid">
							...
							<?php 
							$sql1="SELECT * FROM products WHERE product_cat='$get_scat_id' AND  p_status='Active' ORDER BY id DESC";
