 ...
 <style>
  ...
  margin-right: -3px; /* Optional, to be explicit */
  overflow: hidden;
  position: relative;
  flex-shrink: 0;
...
<div class="product-in-stock-wrapp">
 ...
 <?php 
            $sql1="SELECT * FROM products WHERE featured_product=1 AND  p_status='Active' ORDER BY id DESC LIMIT 6";
            $rztl1=mysqli_query($conn,$sql1);
            if ($rztl1->num_rows>0) {
             ...
             ?>
                ...
                <li class="product-item  col-lg-4 col-md-6 col-sm-6 col-xs-6 col-ts-12 style-3">
                    ...
                    <div class="thumb-inner">
                        <a href="#" tabindex="0">
                            <img style="height: 130px" src="Admin/Product_Image/<?php echo $row1['product_image'];?>" alt="img">
                        </a>
                    </div>
                ...
                <div class="product-info">
                    <h5 class="product-name product_title">
                        <a href="#" tabindex="0"><?php echo $row1['product_name'];?></a>
                    </h5>
                    <div class="group-info">
                        <div class="stars-rating">
                            <div class="star-rating">
                        ...
                        <div class="price">
                            <span> $<?php echo number_format($row1['product_price'],2);?></span>
                        </div>
                    </div>
                    <div class="group-buttons">
                        ...
                        <button onclick="window.location.href='Product-Details?p=<?php echo $row1['prod_no'];?>'" class="add_to_cart_button button" tabindex="0">Shop now</button>
                    </div>
                </div>
            </div>
        </li>
